...
/// </summary>
public class MyCustomItem : ItemInstanceBehaviour
{
    ...
    {
        Debug.Log("ConfigItem called for MyCustomItem");
        ...
        try
        {
            ...
            isInitialized = true;
            Debug.Log("MyCustomItem initialized successfully");
        }
        catch (Exception e)
        {
    ...
    private void Update()
    {
        ...
        {
            Debug.LogWarning("MyCustomItem: Missing component in Update");
            return;
        }
