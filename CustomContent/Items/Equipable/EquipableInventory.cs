    ...
    public static Transform[] getPlayerRigTransformsAsExpectedByDbExportedFbx(Player player)
    {
        ...
        else
        {
            var playerBones = new List<Transform>
            {
                ...
                player.transform.Find("RigCreator/Rig/Armature/Hand_L/Finger_Index_1_L"),
                player.transform.Find("RigCreator/Rig/Armature/Hand_L/Finger_Index_1_L/Finger_Index_2_L"),
                player.transform.Find("RigCreator/Rig/Armature/Hand_L/Finger_Index_1_L/Finger_Index_2_L/Finger_Index_3_L"),
                player.transform.Find("RigCreator/Rig/Armature/Hand_L/Finger_Middle_1_L"),
                player.transform.Find("RigCreator/Rig/Armature/Hand_L/Finger_Middle_1_L/Finger_Middle_2_L"),
                player.transform.Find("RigCreator/Rig/Armature/Hand_L/Finger_Middle_1_L/Finger_Middle_2_L/Finger_Middle_3_L"),
                player.transform.Find("RigCreator/Rig/Armature/Hand_L/Finger_Pinky_1_L"),
                player.transform.Find("RigCreator/Rig/Armature/Hand_L/Finger_Pinky_1_L/Finger_Pinky_2_L"),
                player.transform.Find("RigCreator/Rig/Armature/Hand_L/Finger_Pinky_1_L/Finger_Pinky_2_L/Finger_Pinky_3_L"),
                player.transform.Find("RigCreator/Rig/Armature/Hand_L/Finger_Ring_1_L"),
                player.transform.Find("RigCreator/Rig/Armature/Hand_L/Finger_Ring_1_L/Finger_Ring_2_L"),
                player.transform.Find("RigCreator/Rig/Armature/Hand_L/Finger_Ring_1_L/Finger_Ring_2_L/Finger_Ring_3_L"),
                player.transform.Find("RigCreator/Rig/Armature/Hand_L/Thumb_L_1"),
                player.transform.Find("RigCreator/Rig/Armature/Hand_L/Thumb_L_1/Thumb_L_2"),
                player.transform.Find("RigCreator/Rig/Armature/Hand_L/Thumb_L_1/Thumb_L_2/Thumb_L_3"),
                ...
                player.transform.Find("RigCreator/Rig/Armature/Hand_R/Finger_Index_1_R"),
                player.transform.Find("RigCreator/Rig/Armature/Hand_R/Finger_Index_1_R/Finger_Index_2_R"),
                player.transform.Find("RigCreator/Rig/Armature/Hand_R/Finger_Index_1_R/Finger_Index_2_R/Finger_Index_3_R"),
                player.transform.Find("RigCreator/Rig/Armature/Hand_R/Finger_Middle_1_R"),
                player.transform.Find("RigCreator/Rig/Armature/Hand_R/Finger_Middle_1_R/Finger_Middle_2_R"),
                player.transform.Find("RigCreator/Rig/Armature/Hand_R/Finger_Middle_1_R/Finger_Middle_2_R/Finger_Middle_3_R"),
                player.transform.Find("RigCreator/Rig/Armature/Hand_R/Finger_Pinky_1_R"),
                player.transform.Find("RigCreator/Rig/Armature/Hand_R/Finger_Pinky_1_R/Finger_Pinky_2_R"),
                player.transform.Find("RigCreator/Rig/Armature/Hand_R/Finger_Pinky_1_R/Finger_Pinky_2_R/Finger_Pinky_3_R"),
                player.transform.Find("RigCreator/Rig/Armature/Hand_R/Finger_Ring_1_R"),
                player.transform.Find("RigCreator/Rig/Armature/Hand_R/Finger_Ring_1_R/Finger_Ring_2_R"),
                player.transform.Find("RigCreator/Rig/Armature/Hand_R/Finger_Ring_1_R/Finger_Ring_2_R/Finger_Ring_3_R"),
                player.transform.Find("RigCreator/Rig/Armature/Hand_R/Thumb_1_R"),
                player.transform.Find("RigCreator/Rig/Armature/Hand_R/Thumb_1_R/Thumb_2_R"),
                player.transform.Find("RigCreator/Rig/Armature/Hand_R/Thumb_1_R/Thumb_2_R/Thumb_3_R"),
